    ...
    spawnEntity: function(coll, obj){
        ...
        var rand = !obj.color ? app.random() : 0,
            ...
            entity = new Entity(_.extend({
                ...
                pos: Vector.create([Math.round(app.random()*app.viewportWidth), Math.round(app.random()*app.viewportHeight), 0])
            }, obj));
...
var Proj = app.Proj = Entity.extend({
    ...
    collisionCallback: function (entity) {
        ...
        // Enityi#injure returns true when the injury was fatal.
...
var AppView = Backbone.View.extend({
    ...
    // This code launches projectiles in random directions
    // from the location of a mouse click.
    /*handleClick: function (e) {
        var randomizeSign = function(x){ return x * Math.pow(-1, Math.round(app.random()*10)); };
        var projectiles = [];
        for(var i = 0; i < 10; i++){
